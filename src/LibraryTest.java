...
public class LibraryTest {
	...
	Library.Book[] sortedShelve1 = {
			...
			new Library.Book(16, "And all that glitters is gold", "Cookie", 2001, 1000),
			new Library.Book(17, "Only shooting stars break the mold", "Sadly no Bee Movie reference", 2001, 1000)
	};
	...
	Library.Book[] unsortedShelve1 = {
			...
			new Library.Book(13, "You'll never shine if you don't glow", "Handsome Shrek", 2001, 1000),
			new Library.Book(15, "Hey, now, you're a rock star, get the show on, get paid", "Magic Mirror", 2001, 1000),
			new Library.Book(17, "Only shooting stars break the mold", "Three Blind Mice", 2001, 1000),
			new Library.Book(5, "In the shape of an \"L\" on her forehead", "Gingerbread man", 2001, 1000)
	};
    ...
    public void testBinarySearch() {
        ...
        assertEquals(-1, Library.binarySearch(unsortedShelve1, new Library.Book(0, "You thought it would be a test case but it was me", "Dio", 2001, 1000)));
        assertEquals(-1, Library.binarySearch(unsortedShelve1, new Library.Book(0, "Ora ora ora ora", "Some guy", 2001, 1000)));
        long st = System.nanoTime();
        assertEquals(11, Library.binarySearch(sortedShelve1, new Library.Book(10, "So much to do, so much to see", "Princess Charming", 2001, 1000)));
        long et = System.nanoTime();
        //System.out.println("Binary Search Time (Found): " + (et-st) + " nanoseconds.");
        st = System.nanoTime();
        assertEquals(-1, Library.binarySearch(sortedShelve1, new Library.Book(0, "You thought it would be a test case but it was me", "Dio", 2001, 1000)));
        et = System.nanoTime();
